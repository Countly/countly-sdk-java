...
public class BackendModeExample {
    ...
    private static void recordUserDetailAndProperties() {
        ...
        Countly.instance().backendModule().recordUserProperties(DEVICE_ID, userDetail, null);
    }
    ...
    private static void recordView() {
        ...
        Countly.instance().backendModule().recordView(DEVICE_ID, "SampleView", segmentation, 1646640780130L);
    }
    ...
    private static void recordEvent() {
        ...
        Countly.instance().backendModule().recordEvent(DEVICE_ID, "Event Key", 1, 0.1, 5.0, segment, null);
    }
    ...
    private static void recordExceptionWithThrowableAndSegmentation() {
        ...
        try {
            ...
            Countly.instance().backendModule().recordException(DEVICE_ID, e, segmentation, crashDetails, null);
        }
    }
    ...
    private static void recordExceptionWithMessageAndSegmentation() {
        ...
        try {
            ...
            Countly.instance().backendModule().recordException(DEVICE_ID, "Divided By Zero", "stack traces", segmentation, crashDetails, null);
        }
    }
    ...
    private static void recordDirectRequest() {
        ...
        Countly.instance().backendModule().recordDirectRequest(DEVICE_ID, requestData, null);
    }
    ...
    private static void startSession() {
        ...
        Countly.instance().backendModule().sessionBegin(DEVICE_ID, metrics, location, null);
    }
        ...
        while (running) {
            ...
            switch (input) {
                ...
                case 7: // update session
                    Countly.instance().backendModule().sessionUpdate(DEVICE_ID, 10, null);
                    break;
                case 8: // end session
                    Countly.instance().backendModule().sessionEnd(DEVICE_ID, 20, null);
                    break;
